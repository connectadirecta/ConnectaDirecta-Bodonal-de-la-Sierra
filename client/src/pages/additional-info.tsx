        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
              <div>
                <h3 className="font-semibold text-foreground mb-1">PRESUPUESTO</h3>
                <p className="text-foreground">100.000 euros</p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-1">AYUDA RECIBIDA</h3>
                <p className="text-foreground">100.000 euros</p>
              </div>
            </div>

            <div className="pt-4 border-t">
              <h3 className="font-semibold text-foreground mb-2">FONDO/PROGRAMA</h3>
              <p className="text-foreground">
